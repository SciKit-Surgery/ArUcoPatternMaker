...
This is the software requirements file for ArUcoPatternMaker, part of the
SNAPPY project. The requirements listed below should define
what ArUcoPatternMaker does. Each requirement can be matched to a unit test that
